    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <a href="{{ route('transaksi.index') }}" class="btn btn-user">
                    <i class="bi bi-house-check"></i>Transaction</a>
                @endif
                @if (Auth::user()->role == 'user')
                <a href="{{ route('view.index') }}" class="btn btn-user">
                    <i class="bi bi-house-check"></i>Check</a>
                @endif
            </div>
