@extends('admin.index')
@section('admin')
<h4 class="fw-bold py-1 mt-3 ms-4 "><span class="text-muted fw-light">Update Item/</span> Item</h4>
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
      <form id="contactForm" method="POST" action="{{ route('barang.update',$row->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT') 
        <div class="row">
          <div class="col-md-5">
